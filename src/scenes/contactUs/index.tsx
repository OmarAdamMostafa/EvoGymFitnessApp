                ...
                <div className="mt-10 justify-between gap-8 md:flex">
                    ...
                    >
                        <form 
                            ...
                            onSubmit={onSubmit}
                            method='POST'
                            action="https://formspree.io/f/xayzopzq"
                        >
                            {/* NAME */}
                            <input
                            ...
                            />
                            {
                                errors.name && (
                                    <p className="mt-1 text-primary-500">
                                        ...
                                        {errors.name.type === 'minLength' && 'Min Length is 2 characters.'}
                                    </p>
                                )
                            }
                    ...
                    >
                        <div className="before:absolute md:before:content-evolvetext
                            w-full before:-bottom-20 before:-right-10 before:z-[-1]">
